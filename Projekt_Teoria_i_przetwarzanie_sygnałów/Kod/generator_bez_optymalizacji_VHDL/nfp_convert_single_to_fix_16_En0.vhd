-- -------------------------------------------------------------
-- 
-- File Name: hdlsrcx/lookupTable/nfp_convert_single_to_fix_16_En0.vhd
...
-- Source Path: lookupTable/sys/lookupFun/nfp_convert_single_to_fix_16_En0
-- Hierarchy Level: 3
-- 
...
ENTITY nfp_convert_single_to_fix_16_En0 IS
...
END nfp_convert_single_to_fix_16_En0;


ARCHITECTURE rtl OF nfp_convert_single_to_fix_16_En0 IS
  ...
  SIGNAL Delay4_out1_1                    : unsigned(39 DOWNTO 0);  -- ufix40_En24
  ...
  SIGNAL Delay6_out1                      : unsigned(39 DOWNTO 0);  -- ufix40_En24
  SIGNAL Switch1_out1                     : unsigned(39 DOWNTO 0);  -- ufix40_En24
  SIGNAL Delay9_out1                      : unsigned(39 DOWNTO 0);  -- ufix40_En24
  ...
  SIGNAL Delay8_out1                      : unsigned(15 DOWNTO 0);  -- ufix16
...
BEGIN
  ...
  Data_Type_Conversion_out1 <= resize(Delay2_out1 & '0', 40);
  ...
  BEGIN
    IF reset = '1' THEN
      Delay4_out1_1 <= to_unsigned(0, 40);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Data_Type_Conversion1_out1_1 <= resize(Delay2_out1 & '0', 40);
  ...
  Data_Type_Conversion1_out1_2 <= signed(resize(Delay9_out1, 41));
  ...
  Data_Type_Conversion2_out1 <= unsigned(Switch1_out1_1(39 DOWNTO 24));
