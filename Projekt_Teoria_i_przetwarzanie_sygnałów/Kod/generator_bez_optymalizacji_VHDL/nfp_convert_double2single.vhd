-- -------------------------------------------------------------
-- 
-- File Name: hdlsrcx/lookupTable/nfp_convert_double2single.vhd
...
-- Source Path: lookupTable/sys/lookupFun/nfp_convert_double2single
-- Hierarchy Level: 3
-- 
...
ARCHITECTURE rtl OF nfp_convert_double2single IS
  ...
  SIGNAL Delay32_PS_2_5_reg               : std_logic_vector(0 TO 4);  -- ufix1 [5]
  SIGNAL Delay32_PS_2_5_reg_next          : std_logic_vector(0 TO 4);  -- ufix1 [5]
  SIGNAL Delay32_PS_2_5_out1              : std_logic;  -- ufix1
  SIGNAL Constant1_out1                   : std_logic;  -- ufix1
  SIGNAL Switch1_out1                     : std_logic;  -- ufix1
  SIGNAL Delay3_PS_6_out1                 : std_logic;  -- ufix1
  SIGNAL Delay1_PS_1_out1                 : unsigned(10 DOWNTO 0);  -- ufix11
  SIGNAL inExponent_inType_Exponent_out1  : std_logic;  -- ufix1
  SIGNAL Delay33_PS_2_5_reg               : std_logic_vector(0 TO 3);  -- ufix1 [4]
  SIGNAL Delay33_PS_2_5_reg_next          : std_logic_vector(0 TO 3);  -- ufix1 [4]
  SIGNAL Delay33_PS_2_5_out1              : std_logic;  -- ufix1
  ...
  SIGNAL Delay23_PS_5_reg                 : std_logic_vector(0 TO 1);  -- ufix1 [2]
  SIGNAL Delay23_PS_5_reg_next            : std_logic_vector(0 TO 1);  -- ufix1 [2]
  SIGNAL Delay23_PS_5_out1                : std_logic;  -- ufix1
  ...
  SIGNAL Delay34_PS_2_out1                : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL Delay35_PS_2_out1                : unsigned(5 DOWNTO 0);  -- ufix6
  ...
  SIGNAL Delay18_PS_5_reg                 : std_logic_vector(0 TO 2);  -- ufix1 [3]
  SIGNAL Delay18_PS_5_reg_next            : std_logic_vector(0 TO 2);  -- ufix1 [3]
  SIGNAL Delay18_PS_5_out1                : std_logic;  -- ufix1
  SIGNAL e_cfType_MantissaLength_out1     : std_logic;  -- ufix1
  SIGNAL Delay17_PS_5_reg                 : std_logic_vector(0 TO 2);  -- ufix1 [3]
  SIGNAL Delay17_PS_5_reg_next            : std_logic_vector(0 TO 2);  -- ufix1 [3]
  SIGNAL Delay17_PS_5_out1                : std_logic;  -- ufix1
  SIGNAL C7_out1                          : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL alpha0_out1_1                    : std_logic;  -- ufix1
  SIGNAL e_0_out1                         : std_logic;  -- ufix1
  SIGNAL Delay12_PS_3_out1                : std_logic;  -- ufix1
  SIGNAL Delay29_PS_2_out1                : unsigned(52 DOWNTO 0);  -- ufix53
  SIGNAL bitsll_MantAppended_x_shift_l_out1 : unsigned(52 DOWNTO 0);  -- ufix53
  SIGNAL Delay9_PS_3_out1                 : unsigned(52 DOWNTO 0);  -- ufix53
  SIGNAL C1_out1                          : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL alpha1_e_out1                    : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL Delay11_PS_3_out1                : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL Delay7_PS_4_out1                 : unsigned(52 DOWNTO 0);  -- ufix53
  SIGNAL BitSlice1_out1                   : unsigned(23 DOWNTO 0);  -- ufix24
  SIGNAL Delay21_PS_5_out1                : unsigned(23 DOWNTO 0);  -- ufix24
  ...
  SIGNAL Delay3_PS_4_out1                 : std_logic;  -- ufix1
  SIGNAL Delay14_PS_3_out1                : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL shift_length_MantExtended_x_out1 : std_logic;  -- ufix1
  SIGNAL Delay8_PS_4_out1                 : unsigned(52 DOWNTO 0);  -- ufix53
  ...
  SIGNAL Delay6_PS_4_out1                 : unsigned(5 DOWNTO 0);  -- ufix6
  ...
  SIGNAL Delay15_PS_4_out1                : std_logic;  -- ufix1
  ...
  SIGNAL Delay4_PS_4_out1                 : std_logic;  -- ufix1
  ...
  SIGNAL Delay19_PS_5_out1                : std_logic;  -- ufix1
  ...
  SIGNAL Delay20_PS_5_reg                 : vector_of_unsigned8(0 TO 2);  -- ufix8 [3]
  SIGNAL Delay20_PS_5_reg_next            : vector_of_unsigned8(0 TO 2);  -- ufix8 [3]
  SIGNAL Delay20_PS_5_out1                : unsigned(7 DOWNTO 0);  -- ufix8
  ...
  SIGNAL Delay5_PS_6_out1                 : unsigned(7 DOWNTO 0);  -- ufix8
  ...
  SIGNAL Delay22_PS_5_reg                 : vector_of_unsigned23(0 TO 1);  -- ufix23 [2]
  SIGNAL Delay22_PS_5_reg_next            : vector_of_unsigned23(0 TO 1);  -- ufix23 [2]
  SIGNAL Delay22_PS_5_out1                : unsigned(22 DOWNTO 0);  -- ufix23
  ...
  SIGNAL Switch6_out1_2                   : unsigned(22 DOWNTO 0);  -- ufix23
  SIGNAL Delay4_PS_6_out1                 : unsigned(22 DOWNTO 0);  -- ufix23
...
BEGIN
  ...
  Delay32_PS_2_5_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay32_PS_2_5_reg(0) <= '0';
      Delay32_PS_2_5_reg(1) <= '0';
      Delay32_PS_2_5_reg(2) <= '0';
      Delay32_PS_2_5_reg(3) <= '0';
      Delay32_PS_2_5_reg(4) <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay32_PS_2_5_reg(0) <= Delay32_PS_2_5_reg_next(0);
        Delay32_PS_2_5_reg(1) <= Delay32_PS_2_5_reg_next(1);
        Delay32_PS_2_5_reg(2) <= Delay32_PS_2_5_reg_next(2);
        Delay32_PS_2_5_reg(3) <= Delay32_PS_2_5_reg_next(3);
        Delay32_PS_2_5_reg(4) <= Delay32_PS_2_5_reg_next(4);
      END IF;
    END IF;
  END PROCESS Delay32_PS_2_5_process;

  Delay32_PS_2_5_out1 <= Delay32_PS_2_5_reg(4);
  Delay32_PS_2_5_reg_next(0) <= inSign;
  Delay32_PS_2_5_reg_next(1) <= Delay32_PS_2_5_reg(0);
  Delay32_PS_2_5_reg_next(2) <= Delay32_PS_2_5_reg(1);
  Delay32_PS_2_5_reg_next(3) <= Delay32_PS_2_5_reg(2);
  Delay32_PS_2_5_reg_next(4) <= Delay32_PS_2_5_reg(3);

  Constant1_out1 <= '0';

  
  Switch1_out1 <= Delay32_PS_2_5_out1 WHEN Delay1_out1 = '0' ELSE
      Constant1_out1;
  ...
  inExponent_inType_Exponent_out1 <= '1' WHEN Delay1_PS_1_out1 = to_unsigned(16#7FF#, 11) ELSE
      '0';

  Delay33_PS_2_5_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay33_PS_2_5_reg(0) <= '0';
      Delay33_PS_2_5_reg(1) <= '0';
      Delay33_PS_2_5_reg(2) <= '0';
      Delay33_PS_2_5_reg(3) <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay33_PS_2_5_reg(0) <= Delay33_PS_2_5_reg_next(0);
        Delay33_PS_2_5_reg(1) <= Delay33_PS_2_5_reg_next(1);
        Delay33_PS_2_5_reg(2) <= Delay33_PS_2_5_reg_next(2);
        Delay33_PS_2_5_reg(3) <= Delay33_PS_2_5_reg_next(3);
      END IF;
    END IF;
  END PROCESS Delay33_PS_2_5_process;

  Delay33_PS_2_5_out1 <= Delay33_PS_2_5_reg(3);
  Delay33_PS_2_5_reg_next(0) <= inExponent_inType_Exponent_out1;
  Delay33_PS_2_5_reg_next(1) <= Delay33_PS_2_5_reg(0);
  Delay33_PS_2_5_reg_next(2) <= Delay33_PS_2_5_reg(1);
  Delay33_PS_2_5_reg_next(3) <= Delay33_PS_2_5_reg(2);

  
  inExponent_0_out1 <= '1' WHEN Delay1_PS_1_out1 = to_unsigned(16#000#, 11) ELSE
      '0';
  ...
  inMantissa_0_out1 <= '1' WHEN Delay2_PS_1_out1 = to_unsigned(0, 52) ELSE
      '0';

  alphainExponent_0_inMantis_out1 <= inExponent_0_out1 AND inMantissa_0_out1;

  Delay23_PS_5_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay23_PS_5_reg(0) <= '0';
      Delay23_PS_5_reg(1) <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay23_PS_5_reg(0) <= Delay23_PS_5_reg_next(0);
        Delay23_PS_5_reg(1) <= Delay23_PS_5_reg_next(1);
      END IF;
    END IF;
  END PROCESS Delay23_PS_5_process;

  Delay23_PS_5_out1 <= Delay23_PS_5_reg(1);
  Delay23_PS_5_reg_next(0) <= alphainExponent_0_inMantis_out1;
  Delay23_PS_5_reg_next(1) <= Delay23_PS_5_reg(0);

  
  Exponent_0_out1 <= '1' WHEN Delay1_PS_1_out1 = to_unsigned(16#000#, 11) ELSE
      '0';
  ...
  Delay34_PS_2_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay34_PS_2_out1 <= to_signed(16#000#, 12);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay34_PS_2_out1 <= int32_storedInteger_ExpCorrect_out1;
      END IF;
    END IF;
  END PROCESS Delay34_PS_2_process;


  uint8_MantAppended_x_WordLengt_out1 <= to_unsigned(16#35#, 6);

  
  Exponent_0_out1_1 <= '1' WHEN Delay1_PS_1_out1 = to_unsigned(16#000#, 11) ELSE
      '0';

  
  cfType_Exponent_Inf_or_NaN_out1 <= '1' WHEN Delay1_PS_1_out1 = to_unsigned(16#0FF#, 11) ELSE
      '0';
  ...
  Delay35_PS_2_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay35_PS_2_out1 <= to_unsigned(16#00#, 6);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay35_PS_2_out1 <= Switch6_out1_1;
      END IF;
    END IF;
  END PROCESS Delay35_PS_2_process;


  uint8_MantAppended_x_WordLengt_sub_cast <= signed(resize(uint8_MantAppended_x_WordLengt_out1, 7));
  uint8_MantAppended_x_WordLengt_sub_cast_1 <= signed(resize(Delay35_PS_2_out1, 7));
  ...
  e_int32_shift_length_out1 <= Delay34_PS_2_out1 - e_int32_shift_length_sub_cast;

  
  e_int32_255_out1 <= '1' WHEN e_int32_shift_length_out1 >= to_signed(16#0FF#, 12) ELSE
      '0';

  Delay18_PS_5_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay18_PS_5_reg(0) <= '0';
      Delay18_PS_5_reg(1) <= '0';
      Delay18_PS_5_reg(2) <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay18_PS_5_reg(0) <= Delay18_PS_5_reg_next(0);
        Delay18_PS_5_reg(1) <= Delay18_PS_5_reg_next(1);
        Delay18_PS_5_reg(2) <= Delay18_PS_5_reg_next(2);
      END IF;
    END IF;
  END PROCESS Delay18_PS_5_process;

  Delay18_PS_5_out1 <= Delay18_PS_5_reg(2);
  Delay18_PS_5_reg_next(0) <= e_int32_255_out1;
  Delay18_PS_5_reg_next(1) <= Delay18_PS_5_reg(0);
  Delay18_PS_5_reg_next(2) <= Delay18_PS_5_reg(1);

  
  e_cfType_MantissaLength_out1 <= '1' WHEN e_int32_shift_length_out1 > to_signed(-16#019#, 12) ELSE
      '0';

  Delay17_PS_5_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay17_PS_5_reg(0) <= '0';
      Delay17_PS_5_reg(1) <= '0';
      Delay17_PS_5_reg(2) <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay17_PS_5_reg(0) <= Delay17_PS_5_reg_next(0);
        Delay17_PS_5_reg(1) <= Delay17_PS_5_reg_next(1);
        Delay17_PS_5_reg(2) <= Delay17_PS_5_reg_next(2);
      END IF;
    END IF;
  END PROCESS Delay17_PS_5_process;

  Delay17_PS_5_out1 <= Delay17_PS_5_reg(2);
  Delay17_PS_5_reg_next(0) <= e_cfType_MantissaLength_out1;
  Delay17_PS_5_reg_next(1) <= Delay17_PS_5_reg(0);
  Delay17_PS_5_reg_next(2) <= Delay17_PS_5_reg(1);
  ...
  Delay12_PS_3_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay12_PS_3_out1 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  Delay29_PS_2_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay29_PS_2_out1 <= to_unsigned(0, 53);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay29_PS_2_out1 <= if_Exponent_0_cfType_Exp_out1;
      END IF;
    END IF;
  END PROCESS Delay29_PS_2_process;


  bitsll_MantAppended_x_shift_l_out1 <= Delay29_PS_2_out1 sll to_integer(uint8_MantAppended_x_WordLengt_out1_1);

  Delay9_PS_3_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay9_PS_3_out1 <= to_unsigned(0, 53);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Delay11_PS_3_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay11_PS_3_out1 <= to_signed(16#000#, 12);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Data_Type_Conversion_out1_1 <= unsigned(Delay11_PS_3_out1(5 DOWNTO 0));

  bitsrl_MantExtended_x_shift_l_out1 <= SHIFT_RIGHT(Delay9_PS_3_out1, to_integer(Data_Type_Conversion_out1_1));

  
  if_e_0_MantExtended_x_out1 <= bitsrl_MantExtended_x_shift_l_out1 WHEN Delay12_PS_3_out1 = '0' ELSE
      Delay9_PS_3_out1;

  Delay7_PS_4_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay7_PS_4_out1 <= to_unsigned(0, 53);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  BitSlice1_out1 <= Delay7_PS_4_out1(51 DOWNTO 28);

  Delay21_PS_5_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay21_PS_5_out1 <= to_unsigned(16#000000#, 24);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay21_PS_5_out1 <= BitSlice1_out1;
      END IF;
    END IF;
  END PROCESS Delay21_PS_5_process;


  Bit_Concat_out1_1 <= alpha0_out1_1 & Delay21_PS_5_out1;
  ...
  shift_length1_0_out1 <= '1' WHEN Delay11_PS_3_out1 > to_signed(16#000#, 12) ELSE
      '0';
  ...
  Delay14_PS_3_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay14_PS_3_out1 <= to_unsigned(16#00#, 6);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  shift_length_MantExtended_x_out1 <= '1' WHEN Delay14_PS_3_out1 = to_unsigned(16#35#, 6) ELSE
      '0';

  Delay8_PS_4_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay8_PS_4_out1 <= to_unsigned(0, 53);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Bit_Slice33_out1 <= Delay8_PS_4_out1(52);
  ...
  MantExtended_x_WordLength_sub_temp <= MantExtended_x_WordLength_sub_cast - resize(Delay11_PS_3_out1, 14);
  ...
  BEGIN
    IF reset = '1' THEN
      Delay6_PS_4_out1 <= to_unsigned(16#00#, 6);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Bit_Slice1_out1_2 <= Delay6_PS_4_out1(2);
  ...
  Bit_Slice3_out1_1 <= Delay6_PS_4_out1(3);

  Bit_Slice5_out1_1 <= Delay6_PS_4_out1(0);
  ...
  Bit_Slice2_out1_2 <= Delay6_PS_4_out1(1);
  ...
  Bit_Slice31_out1 <= Delay8_PS_4_out1(50 DOWNTO 48);
  ...
  Bit_Slice4_out1_2 <= Delay6_PS_4_out1(4);

  Bit_Slice25_out1 <= Delay8_PS_4_out1(46 DOWNTO 44);
  ...
  Bit_Slice29_out1 <= Delay8_PS_4_out1(42 DOWNTO 40);
  ...
  Bit_Slice23_out1 <= Delay8_PS_4_out1(38 DOWNTO 36);
  ...
  Bit_Slice21_out1 <= Delay8_PS_4_out1(34 DOWNTO 32);
  ...
  Bit_Slice17_out1 <= Delay8_PS_4_out1(30 DOWNTO 28);
  ...
  Bit_Slice15_out1_5 <= Delay8_PS_4_out1(26 DOWNTO 24);
  ...
  Bit_Slice19_out1 <= Delay8_PS_4_out1(22 DOWNTO 20);
  ...
  Bit_Slice13_out1_6 <= Delay8_PS_4_out1(18 DOWNTO 16);
  ...
  Bit_Slice11_out1_6 <= Delay8_PS_4_out1(14 DOWNTO 12);
  ...
  Bit_Slice9_out1_7 <= Delay8_PS_4_out1(10 DOWNTO 8);
  ...
  Bit_Slice7_out1_2 <= Delay8_PS_4_out1(6 DOWNTO 4);
  ...
  Bit_Slice_out1_12 <= Delay8_PS_4_out1(2 DOWNTO 0);
  ...
  Delay15_PS_4_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay15_PS_4_out1 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      ...
      END IF;
    END IF;
  END PROCESS Delay15_PS_4_process;


  Bit_Slice27_out1 <= Delay6_PS_4_out1(5);
  ...
  if_shift_length_MantExtended_out1 <= Logical_Operator5_out1_24 WHEN Delay15_PS_4_out1 = '0' ELSE
      C3_out1;

  
  if_shift_length1_0_out1 <= C4_out1 WHEN Delay3_PS_4_out1 = '0' ELSE
      if_shift_length_MantExtended_out1;

  Bit_Slice33_out1_1 <= Delay7_PS_4_out1(52);
  ...
  Bit_Slice31_out1_1 <= Delay7_PS_4_out1(50 DOWNTO 48);
  ...
  Bit_Slice25_out1_1 <= Delay7_PS_4_out1(46 DOWNTO 44);
  ...
  Bit_Slice29_out1_1 <= Delay7_PS_4_out1(42 DOWNTO 40);
  ...
  Bit_Slice23_out1_1 <= Delay7_PS_4_out1(38 DOWNTO 36);
  ...
  Bit_Slice21_out1_1 <= Delay7_PS_4_out1(34 DOWNTO 32);
  ...
  Bit_Slice17_out1_1 <= Delay7_PS_4_out1(30 DOWNTO 28);
  ...
  Bit_Slice15_out1_6 <= Delay7_PS_4_out1(26 DOWNTO 24);
  ...
  Bit_Slice19_out1_1 <= Delay7_PS_4_out1(22 DOWNTO 20);
  ...
  Bit_Slice13_out1_7 <= Delay7_PS_4_out1(18 DOWNTO 16);
  ...
  Bit_Slice11_out1_7 <= Delay7_PS_4_out1(14 DOWNTO 12);
  ...
  Bit_Slice9_out1_8 <= Delay7_PS_4_out1(10 DOWNTO 8);
  ...
  Bit_Slice7_out1_3 <= Delay7_PS_4_out1(6 DOWNTO 4);
  ...
  Bit_Slice_out1_26 <= Delay7_PS_4_out1(2 DOWNTO 0);
  ...
  if_e_0_sticky_out1 <= if_shift_length1_0_out1 WHEN Delay4_PS_4_out1 = '0' ELSE
      C6_out1;
  ...
  Delay19_PS_5_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay19_PS_5_out1 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      ...
      END IF;
    END IF;
  END PROCESS Delay19_PS_5_process;


  alphabitget_Mant_tmp_2_0_out1 <= bitget_Mant_tmp_2_0_out1 OR Delay19_PS_5_out1;
  ...
  Delay20_PS_5_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay20_PS_5_reg(0) <= to_unsigned(16#00#, 8);
      Delay20_PS_5_reg(1) <= to_unsigned(16#00#, 8);
      Delay20_PS_5_reg(2) <= to_unsigned(16#00#, 8);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay20_PS_5_reg(0) <= Delay20_PS_5_reg_next(0);
        Delay20_PS_5_reg(1) <= Delay20_PS_5_reg_next(1);
        Delay20_PS_5_reg(2) <= Delay20_PS_5_reg_next(2);
      END IF;
    END IF;
  END PROCESS Delay20_PS_5_process;

  Delay20_PS_5_out1 <= Delay20_PS_5_reg(2);
  Delay20_PS_5_reg_next(0) <= if_e_0_Exponent_out1;
  Delay20_PS_5_reg_next(1) <= Delay20_PS_5_reg(0);
  Delay20_PS_5_reg_next(2) <= Delay20_PS_5_reg(1);

  cast_1_1 <= to_unsigned(16#01#, 8);

  Exp_cast <= resize(Delay20_PS_5_out1, 9) + resize(cast_1_1, 9);

  DTC1_out1 <= Exp_cast(7 DOWNTO 0);

  
  if_bitget_Mant_tmp_Mant_tmp_Wor_Exp_out1 <= Delay20_PS_5_out1 WHEN bitget_Mant_tmp_Mant_tmp_Word_out1 = '0' ELSE
      DTC1_out1;

  
  if_e_cfType_MantissaLength_Exponent_out1 <= C7_out1 WHEN Delay17_PS_5_out1 = '0' ELSE
      if_bitget_Mant_tmp_Mant_tmp_Wor_Exp_out1;

  C8_out1 <= to_unsigned(16#FF#, 8);

  
  if_e_int32_255_Exponent_out1 <= if_e_cfType_MantissaLength_Exponent_out1 WHEN Delay18_PS_5_out1 = '0' ELSE
      C8_out1;

  C11_out1 <= to_unsigned(16#00#, 8);

  
  if_inExponent_0_inMantis_Exponent_out1 <= if_e_int32_255_Exponent_out1 WHEN Delay23_PS_5_out1 = '0' ELSE
      C11_out1;

  C12_out1 <= to_unsigned(16#FF#, 8);

  
  if_inExponent_inType_Exponent_Exponent_out1 <= if_inExponent_0_inMantis_Exponent_out1 WHEN Delay33_PS_2_5_out1 = '0' ELSE
      C12_out1;

  Constant2_out1_1 <= to_unsigned(16#00#, 8);

  
  Switch5_out1_1 <= if_inExponent_inType_Exponent_Exponent_out1 WHEN Delay1_out1 = '0' ELSE
      Constant2_out1_1;

  Delay5_PS_6_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay5_PS_6_out1 <= to_unsigned(16#00#, 8);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay5_PS_6_out1 <= Switch5_out1_1;
      END IF;
    END IF;
  END PROCESS Delay5_PS_6_process;
  ...
  if_e_cfType_MantissaLength_Mantissa_out1 <= C9_out1 WHEN Delay17_PS_5_out1 = '0' ELSE
      if_bitget_Mant_tmp_Mant_tmp_Wor_MantRounded_out1;

  C10_out1 <= to_unsigned(16#000000#, 23);

  
  if_e_int32_255_Mantissa_out1 <= if_e_cfType_MantissaLength_Mantissa_out1 WHEN Delay18_PS_5_out1 = '0' ELSE
      C10_out1;

  C13_out1 <= to_unsigned(16#000000#, 23);

  
  if_inExponent_0_inMantis_Mantissa_out1 <= if_e_int32_255_Mantissa_out1 WHEN Delay23_PS_5_out1 = '0' ELSE
      C13_out1;

  
  inMantissa_0_out1_1 <= '1' WHEN Delay2_PS_1_out1 /= to_unsigned(0, 52) ELSE
      '0';

  BitSlice_out1_1 <= Delay2_PS_1_out1(22 DOWNTO 0);
  ...
  Delay22_PS_5_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay22_PS_5_reg(0) <= to_unsigned(16#000000#, 23);
      Delay22_PS_5_reg(1) <= to_unsigned(16#000000#, 23);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay22_PS_5_reg(0) <= Delay22_PS_5_reg_next(0);
        Delay22_PS_5_reg(1) <= Delay22_PS_5_reg_next(1);
      END IF;
    END IF;
  END PROCESS Delay22_PS_5_process;

  Delay22_PS_5_out1 <= Delay22_PS_5_reg(1);
  Delay22_PS_5_reg_next(0) <= if_inMantissa_0_out1;
  Delay22_PS_5_reg_next(1) <= Delay22_PS_5_reg(0);

  
  if_inExponent_inType_Exponent_Mantissa_out1 <= if_inExponent_0_inMantis_Mantissa_out1 WHEN Delay33_PS_2_5_out1 = '0' ELSE
      Delay22_PS_5_out1;

  Constant3_out1_1 <= to_unsigned(16#000000#, 23);

  
  Switch6_out1_2 <= if_inExponent_inType_Exponent_Mantissa_out1 WHEN Delay1_out1 = '0' ELSE
      Constant3_out1_1;

  Delay4_PS_6_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay4_PS_6_out1 <= to_unsigned(16#000000#, 23);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay4_PS_6_out1 <= Switch6_out1_2;
      END IF;
    END IF;
  END PROCESS Delay4_PS_6_process;


  -- Combine FP sign, exponent, mantissa into 32 bit word
  nfp_out_pack <= Delay3_PS_6_out1 & Delay5_PS_6_out1 & Delay4_PS_6_out1;
