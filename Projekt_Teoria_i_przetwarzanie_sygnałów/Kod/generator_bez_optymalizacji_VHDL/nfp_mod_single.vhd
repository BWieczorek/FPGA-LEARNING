-- -------------------------------------------------------------
-- 
-- File Name: hdlsrcx/lookupTable/nfp_mod_single.vhd
...
-- Source Path: lookupTable/nfp_mod_single
-- Hierarchy Level: 3
-- 
...
BEGIN
  ...
  Delay17_3_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay15_2_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay19_2_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay17_4_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay15_3_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay14_3_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay14_4_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay12_4_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay15_4_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay18_3_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay18_reg(0) <= '0';
      Delay18_reg(1) <= '0';
  ...
  Delay12_5_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay12_out1_5 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  Delay16_3_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay17_5_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay19_3_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay18_4_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay19_4_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
